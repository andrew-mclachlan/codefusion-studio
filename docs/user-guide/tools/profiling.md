...
All build, flash, and profiling operations in CodeFusion Studio are performed using **CFS tasks**. You can run these tasks from the **Actions** view, **Command Palette**, or other locations described in  [Build, clean, flash, and debug tasks](../build-and-flash/tasks.md).
